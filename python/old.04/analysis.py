...
df_data_MEAN_dense = df_data_MEAN.loc[df_data_MEAN['nPOIs'] == 800]



df_file_raw = pd.read_csv("cleanDataFile.txt",sep=';', index_col =["Strategy", "mapName", "nPOIs"] )
...
df_data_RAW_dense = df_data_RAW.loc[df_data_RAW['nPOIs'] == 800]

...
def run_thesis_ploter():
    ...
    line_plots('toursizes_' + str(mysettings.SINGLEUAVCOUNT) + 'UAVs_' ,titleGraphs,df_coll_1UAV_raw,setSizes,xStatsCods,yStatsCods,xLabel,yLabel)
    ...
    boxplots_plots('pathTime_boxplot_' + str(mysettings.SINGLEUAVCOUNT) + 'UAVs_' ,titleGraphs,df_coll_1UAV_median,setSizes,yStatsCods,yLabel)
...
def dataset_analisys():
    ...
    for i in range(0,len(setSizes)):
        ...
        print('setsize ' + setSizes[i] + ' team TSP ' + str(tspcount) + ' rate: ' + str(tspavg))
        print('setsize ' + setSizes[i] + ' team LKH ' + str(lkhcount) + ' rate: ' + str(lkhavg))
        print('setsize ' + setSizes[i] + ' team LKH-cutted ' + str(lkhcuttedcount) + ' rate: ' + str(lkhcutavg))

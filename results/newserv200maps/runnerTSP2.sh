...
do
	...
	./woofyMSG.sh "[$HOST][$TIME] Fim dos TSP x 200 com  $N_POI CHs, indo para o próximo "
...
TIME=$(date)
./woofyMSG.sh "[$HOST][$TIME] Fim dos TSP x200  ...  Liberando slots de processamento para os demais."
echo "[$HOST];[$TIME]; terminou TSP x 200" >> ./simulationResults/acompanhamento.txt

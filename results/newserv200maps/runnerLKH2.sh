...
do
	...
	./woofyMSG.sh "[$HOST][$TIME] Fim dos LKH x 200 com  $N_POI CHs, indo para o próximo "
	
done


TIME=$(date)
./woofyMSG.sh "[$HOST][$TIME] Fim dos testes do LKH x 200 ...  Liberando slots de processamento para os demais."
echo "[$HOST];[$TIME]; terminou LKH x 200 " >> ./simulationResults/acompanhamento.txt

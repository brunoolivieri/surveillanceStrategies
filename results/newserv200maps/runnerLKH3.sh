...
do
	...
	./woofyMSG.sh "[$HOST][$TIME] Fim dos LKH x 100 com  $N_POI CHs, indo para o próximo "
	
done


TIME=$(date)
./woofyMSG.sh "[$HOST][$TIME] LKH x 100 ACABOU totalmente"
echo "[$HOST];[$TIME]; terminou LKH x 100 TOTALMENTE" >> ./simulationResults/acompanhamento.txt

...
touch stats_delays_FPPWRMobility.txt
touch stats_delays_TSPConcorde.txt
touch stats_delays_ZigZagOverNSN.txt
...
./woofy.sh 123705340 "[$HOST][$TIME] Iniciando os testes do DACA e do FPPWR com 20POIs ..."
	...
	do
		...
		do
			...
			if ! ((PERCENTS % 10)); then			
				...
				TIME=$(date)
				./woofy.sh 123705340 "[$HOST][$TIME] LOOPS_EFETUADOS = $LOOPS_EFETUADOS ... "
			fi
...
TIME=$(date)
./woofy.sh 123705340 "[$HOST][$TIME] Fim dos testes com DACA, Concorde e FPPWR com 20POIs ..."
